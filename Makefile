...
SBCOVERLAY_REPOSITORY = https://github.com/charliebravo636/sbc-raspberrypi5.git
...
patches-pkgs:
	cd "$(CHECKOUTS_DIRECTORY)/pkgs" && \
		git am "$(PATCHES_DIRECTORY)/siderolabs/pkgs/0001-Latest-Patched-for-Raspberry-Pi-5.patch"

patches-talos:
	cd "$(CHECKOUTS_DIRECTORY)/talos" && \
		git am "$(PATCHES_DIRECTORY)/siderolabs/talos/0001-Latest-Patched-for-Raspberry-Pi-5.patch"
